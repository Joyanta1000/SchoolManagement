  ...
  <body class="nav-md">
    <div class="container body">
          ...
          <div class="">
           ...
           <!--    <div class="col-md-12 col-sm-12 ">
              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Button Examples <small>Users</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                      </li>
                      <li class="dropdown">
      ...
      <div class="col-md-12" align="right">
       <a href="add_subject.php" type="button" class="btn btn-link" > Click Here to Add Subject </a>
      </div>
                      <thead>
                        <tr>
                          <th>ID</th>
                      ...
                      <tbody>
                       ...
                       <!--  <tr v-for="row in allData">
                          <td>{{ row.id }}</td>
                          <td>{{ row.role }}</td>
                          <td style="text-decoration: none; color: blue;"><a href="" style="color: blue;">Edit</a>&nbsp;&nbsp;<a href="" style="color: red;">Delete</a></td>
                        </tr> -->
...
$data = array();
 ...
 <tr >
                          ...
                          <td><button type="button" name="edit" class="btn btn-link" @click="fetchData(<?php echo $row['id'];?>)">Edit</button> &nbsp;
        <button type="button" name="delete" class="btn btn-link" style="color: red;" @click="deleteData(<?php echo $row['id'];?>)" >Delete</button></td>
                        </tr>
 ...
 // echo json_encode($data);
                      ...
                      <!-- <a href = "index2.php?page=">  {{ row.page }}  </a> -->
                    </table>
       ...
       <div class="modal-dialog">
        <div class="modal-content">
         ...
         <div class="modal-body">
          ...
          <div class="form-group">
           <label>Subject</label>
           <input type="text" class="form-control" v-model="subjects" />
          </div>
         <!--  <div class="form-group">
           <label>Class</label>
           <input type="text" class="form-control" v-model="classes" />
          </div> -->
...
var application = new Vue({
 ...
 methods:{
  ...
  submitData:function(){
   if(application.id != '' && application.role != '')
   {
  ...
  fetchData:function(id){
   axios.post('admins_data.php', {
    action:'fetchSingle_subjects_data',
    id:id
   }).then(function(response){
