...
<div id="app">
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <!-- <form class="" action="" method="post" novalidate> -->
                                        ...
                                        <span class="section">Add Days</span>
                ...
                <br>
                                        ...
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Days <span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input v-model="days" class="form-control" type="text"  name="days" ></div>
                                        </div>
                                        <!-- <div class="field item form-group">
  ...
  var app = new Vue({
   ...
   methods: {
    checkForm: function (e) {
      this.errors = [];
if (!this.days) {
        this.errors.push("Day inquiry required.");
      }
      ...
      this.errors = [];
      axios.post('days_data_insert.php', {
        request: 'day',
        days: this.days,
       })
       .then(function(response) {
        ...
        if (response.status == 200) {
          window.location.href = 'add_days.php';
         alert('Day Added');
        } else {
         alert("Failed to add.");
        }
