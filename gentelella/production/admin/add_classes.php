                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <!-- <form class="" action="" method="post" novalidate> -->
                                        ...
                                        <span class="section">Add Classes</span>
                ...
                <br>
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input v-model="classes" class="form-control" type="text"  name="classes" ></div>
                                        </div>
                                        <!-- <div class="field item form-group">
  ...
  var app = new Vue({
   ...
   methods: {
    checkForm: function (e) {
      this.errors = [];
if (!this.classes) {
        this.errors.push("Class inquiry required.");
      }
      ...
      this.errors = [];
      axios.post('classes_data_insert.php', {
        request: 'class',
       ...
       .then(function(response) {
        ...
        if (response.status == 200) {
          window.location.href = 'add_classes.php';
         alert('Class Added');
        } else {
         alert("Failed to add.");
        }
